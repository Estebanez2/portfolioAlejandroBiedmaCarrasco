...
function ContactIcon({ label }) {
  ...
  return (
    <img
      src={CONTACT_ICONS[key] ?? CONTACT_ICONS.email}
      alt=""
      aria-hidden="true"
    />
  );
...
const CONTACT_ICONS = {
  email: svgDataUrl(`
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
      <path fill="#ffffff" d="M22.29 5.89 12 13.64 1.71 5.89A2 2 0 0 1 3.42 5h17.16a2 2 0 0 1 1.71.89ZM24 7.87V19a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V7.87l11.4 8.59a1 1 0 0 0 1.2 0L24 7.87Z"/>
    </svg>
  `),
  linkedin: svgDataUrl(`
