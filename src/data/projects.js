...
const planImages = (projectId, count) =>
  Array.from({ length: count }, (_, index) => ({
    ...
    image: projectAsset(projectId, `plans/plan-${index + 1}.webp`),
  }));
...
export const projects = [
  {
    ...
    cover: projectAsset("toca-a-tiempo", "images/portada.webp"),
    logo: projectAsset("toca-a-tiempo", "logo/logo.webp"),
    logoHover: projectAsset("toca-a-tiempo", "logo/logo-hoover.webp"),
    brand: projectAsset("toca-a-tiempo", "logo/logo-completo.webp"),
    summary: {
    ...
    gallery: [
      projectAsset("toca-a-tiempo", "renders/juego-memoria-perspectiva-luces.webp"),
      projectAsset("toca-a-tiempo", "renders/juego-memoria-perfil.webp"),
      projectAsset("toca-a-tiempo", "renders/arriba-azul.webp"),
      projectAsset("toca-a-tiempo", "renders/arriba-rojo.webp"),
      projectAsset("toca-a-tiempo", "renders/arriba-verde.webp"),
    ],
    document: projectAsset("toca-a-tiempo", "documents/memoria.pdf"),
    presentation: null,
    plansLayout: "portrait",
    plans: [
      { label: { en: "Drawing 1", es: "Plano 1" }, image: projectAsset("toca-a-tiempo", "plans/plano-1.webp") },
      { label: { en: "Drawing 2", es: "Plano 2" }, image: projectAsset("toca-a-tiempo", "plans/plano-2.webp") },
      { label: { en: "Drawing 3", es: "Plano 3" }, image: projectAsset("toca-a-tiempo", "plans/plano-3.webp") },
      { label: { en: "Drawing 4", es: "Plano 4" }, image: projectAsset("toca-a-tiempo", "plans/plano-4.webp") },
    ],
  },
  {
    id: "spira",
    ...
    cover: projectAsset("spira", "images/portada.webp"),
    modalImage: projectAsset("spira", "renders/Render-aspiradora.webp"),
    model: projectAsset("spira", "glb/spira.glb"),
    modelSettings: {
      autoRotateSpeed: 0.45,
      background:
        "radial-gradient(circle at 30% 18%, rgba(255, 255, 255, 0.82), transparent 34%), linear-gradient(135deg, #f6f6f4 0%, #dededb 52%, #c6c6c2 100%)",
    ...
    logo: projectAsset("spira", "logos/logo.webp"),
    logoHover: projectAsset("spira", "logos/logo-hoover.webp"),
    brand: projectAsset("spira", "logos/logo-completo.webp"),
    summary: {
    ...
    gallery: [
      projectAsset("spira", "renders/cartel-2.webp"),
      projectAsset("spira", "renders/cartel-1.webp"),
      projectAsset("spira", "renders/Motor-Explosionado.mp4"),
      projectAsset("spira", "renders/Puertas-abriendo.mp4"),
      projectAsset("spira", "renders/Render-aspiradora.webp"),
      projectAsset("spira", "renders/Render-aspiradora-de-lao.webp"),
      projectAsset("spira", "renders/Render-motor.webp"),
      projectAsset("spira", "renders/de-frente-aspiradora.webp"),
      projectAsset("spira", "renders/Render-escoba.webp"),
    ],
    document: null,
    presentation: null,
  ...
  },
  {
    ...
    cover: projectAsset("lumarc", "renders/render-entero.webp"),
    modalImage: projectAsset("lumarc", "renders/render-entero.webp"),
    model: projectAsset("lumarc", "glb/LumArc.glb"),
    modelSettings: {
      autoRotateSpeed: 0.45,
      background:
        "radial-gradient(circle at 30% 18%, rgba(255, 255, 255, 0.82), transparent 34%), linear-gradient(135deg, #f6f6f4 0%, #dededb 52%, #c6c6c2 100%)",
    ...
    logo: projectAsset("lumarc", "logos/logo.webp"),
    logoHover: projectAsset("lumarc", "logos/logo-hoover.webp"),
    brand: projectAsset("lumarc", "logos/logo-completo.webp"),
    summary: {
    ...
    gallery: [
      projectAsset("lumarc", "images/portada.webp"),
      projectAsset("lumarc", "renders/render-vistas.webp"),
    ],
  ...
  },
  {
    ...
    cover: projectAsset("g-orb", "images/portada.webp"),
    modalImage: projectAsset("g-orb", "images/portada.webp"),
    coverHover: projectAsset("g-orb", "images/g-orb-encendido.webp"),
    model: projectAsset("g-orb", "glb/g-orb.glb"),
    modelSettings: {
      autoRotateSpeed: 0.5,
      background:
        "radial-gradient(circle at 30% 18%, rgba(255, 255, 255, 0.82), transparent 34%), linear-gradient(135deg, #f6f6f4 0%, #dededb 52%, #c6c6c2 100%)",
      cameraPosition: [3.4, 1.8, 4.2],
      maxDistance: 5.8,
      minDistance: 1.7,
      position: [0, -0.04, 0],
      scale: 2.55,
    ...
    logo: projectAsset("g-orb", "logos/logo.webp"),
    logoHover: projectAsset("g-orb", "logos/logo-hoover.webp"),
    brand: projectAsset("g-orb", "logos/logo-completo.webp"),
    summary: {
    ...
    gallery: [
      projectAsset("g-orb", "renders/render-1.webp"),
      projectAsset("g-orb", "renders/render-2.webp"),
      projectAsset("g-orb", "renders/render-3.webp"),
      projectAsset("g-orb", "renders/render-4.webp"),
      projectAsset("g-orb", "renders/render-5.webp"),
    ],
    galleryLayout: "slideshow",
    galleryFeature: projectAsset("g-orb", "images/g-orb-encendido.webp"),
