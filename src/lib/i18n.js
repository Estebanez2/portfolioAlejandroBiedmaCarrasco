...
export const ui = {
  en: {
    ...
    downloadPresentation: "Project presentation",
    gallery: "Gallery",
    hobbies: "Hobbies",
    interact3d: "Drag to rotate · Scroll to zoom",
    languages: "Languages",
  ...
  es: {
    ...
    downloadPresentation: "Presentación del Proyecto",
    gallery: "Galería",
    hobbies: "Hobbies",
    interact3d: "Arrastra para girar · Rueda para ampliar",
    languages: "Idiomas",
